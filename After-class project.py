...
sprite1=Sprite(pygame.Color('white') , 90,120)
...
sprite2=Sprite(pygame.Color('blue') , 60,90)
...
sprite3=Sprite(pygame.Color('yellow') , 40,70)
sprite2.rect.x, sprite2.rect.y = random.randint(
    0,SCREEN_WIDTH-sprite2.rect.width), random.randint(
        0, SCREEN_HEIGHT - sprite2.rect.height)
...
while running:
    ...
    if not won:
        ...
        if sprite1.rect.colliderect(sprite3.rect):
            ...
            won=True
        if won:
            win_text=font.render("U win, congrats!!!",True, pygame.Color('orange'))
